...
profile_2017_preTS2=profile_2017.clone()
...
def UseConstantXangleBetaStar(process, xangle, betaStar):
  process.profile_2017_preTS2.ctppsLHCInfo.xangle = xangle
  process.profile_2017_preTS2.ctppsLHCInfo.betaStar = betaStar

def UseXangleBetaStarHistogram(process,f, obj):
  process.profile_2017_preTS2.ctppsLHCInfo.xangleBetaStarHistogramFile = f
  process.profile_2017_preTS2.ctppsLHCInfo.xangleBetaStarHistogramObject = obj
