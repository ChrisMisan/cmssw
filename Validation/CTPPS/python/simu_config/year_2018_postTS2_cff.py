...
profile_2018_postTS2=profile_2018.clone()
...
def UseConstantXangleBetaStar(process, xangle, betaStar):
  process.profile_2018_postTS2.ctppsLHCInfo.xangle = xangle
  process.profile_2018_postTS2.ctppsLHCInfo.betaStar = betaStar

def UseXangleBetaStarHistogram(process,f, obj):
  process.profile_2018_postTS2.ctppsLHCInfo.xangleBetaStarHistogramFile = f
  process.profile_2018_postTS2.ctppsLHCInfo.xangleBetaStarHistogramObject = obj
