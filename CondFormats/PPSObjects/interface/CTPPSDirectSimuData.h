#ifndef CondFormats_PPSObjects_CTPPSDirectSimuData_h
#define CondFormats_PPSObjects_CTPPSDirectSimuData_h

#include "CondFormats/Serialization/interface/Serializable.h"
#include "FWCore/MessageLogger/interface/MessageLogger.h"
#include "TH2F.h"
class CTPPSDirectSimuData {
public:
    // Constructor
    CTPPSDirectSimuData();
    // Destructor
...
std::ostream &operator<<(std::ostream &, CTPPSDirectSimuData);
#endif
